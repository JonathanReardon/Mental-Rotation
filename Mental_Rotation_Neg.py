...
''' Mental Rotation / Emotional Valence task - Low Valence '''

# create window
window = visual.Window([800,800],fullscr=False,color=("black"), allowGUI=True, monitor='testMonitor', units='deg')

# instructions
main_instruction = glob.glob(os.path.join('.. Day_1\Instructions','*.jpg'))
...
# practice stimuli
practice_correct = glob.glob(os.path.join('.. Day_2\Practice\Correct','*.jpg'))    
practice_incorrect = glob.glob(os.path.join('.. Day_2\Practice\Incorrect','*.jpg'))
...
block1_correct = glob.glob(os.path.join('.. Day_2\First_block_x20_Day_2\Correct','*.jpg'))
block1_incorrect = glob.glob(os.path.join('.. Day_2\First_block_x20_Day_2\Incorrect','*.jpg'))
...
block2_correct = glob.glob(os.path.join('.. Day_2\Second_block_x20_Day_2\Correct','*.jpg'))
block2_incorrect = glob.glob(os.path.join('C:\Users\Jon\Documents\Sara_and_Molly\Day_2\Second_block_x20_Day_2\Incorrect','*.jpg'))
...
block3_correct = glob.glob(os.path.join('.. Day_2\Third_block_x20_Day_2\Correct','*.jpg'))
block3_incorrect = glob.glob(os.path.join('C:\Users\Jon\Documents\Sara_and_Molly\Day_2\Third_block_x20_Day_2\Incorrect','*.jpg'))
...
neutral_stim = glob.glob(os.path.join('.. Day_2\Neutral','*.jpg'))
neutral_stimlist = [visual.ImageStim(window, img, name='neutral' + img) for img in neutral_stim[:]]
random.shuffle(neutral_stimlist)

# import low negative arousal stimuli
global lownegative_stimlist
lownegative_stim = glob.glob(os.path.join('.. Day_2\Negative\low_negative','*.png'))
lownegative_stimlist = [visual.ImageStim(window, img, name='low_neg' + img) for img in lownegative_stim[:]]
random.shuffle(lownegative_stimlist)

# import high negative arousal stimuli
global highnegative_stimlist
highnegative_stim = glob.glob(os.path.join('.. Day_2\Negative\high_negative','*.png'))
highnegative_stimlist = [visual.ImageStim(window, img, name='high_neg' + img) for img in highnegative_stim[:]]
random.shuffle(highnegative_stimlist)

# set refresh rate & stim display times
refresh_rate = 60.0
stim_dur = 60.0       #duration for mental rotation images (set as 60, but switches on keypress)
arous_image_dur = .1 #duration for arousal images
fixation_dur = .1
...
def practice_correct():
    ...
    while running ==1:
        ...
        if ment_rot_angle[1] == "2" and ment_rot_angle[2] == "5":
            angle = 1
        if ment_rot_angle[1] == "2" and ment_rot_angle[2] == "7":
            angle = 2
        elif ment_rot_angle[1] == "3" and ment_rot_angle[2] == "0":
            angle = 3
...
def practice_incorrect():
    ...
    while running ==1:
        ...
        if ment_rot_angle[1] == "2" and ment_rot_angle[2] == "6":
            angle = 1
        if ment_rot_angle[1] == "2" and ment_rot_angle[2] == "8":
            angle = 2
        elif ment_rot_angle[1] == "2" and ment_rot_angle[2] == "9":
            angle = 3
        running = 2
...
def block1_correct():
    ...
    while running ==1:
        ...
        if ment_rot_angle[1] == "3" and ment_rot_angle[2] == "1" or ment_rot_angle[1] == "3" and ment_rot_angle[2] == "4":
            angle = 1
        if ment_rot_angle[1] == "3" and ment_rot_angle[2] == "5" or ment_rot_angle[1] == "3" and ment_rot_angle[2] == "8" or ment_rot_angle[1] == "4" and ment_rot_angle[2] == "0" or ment_rot_angle[1] == "4" and ment_rot_angle[2] == "2":
            angle = 2
        elif ment_rot_angle[1] == "2" and ment_rot_angle[2] == "_" or ment_rot_angle[1] == "4" and ment_rot_angle[2] == "3" or ment_rot_angle[1] == "4" and ment_rot_angle[2] == "6" or ment_rot_angle[1] == "4" and ment_rot_angle[2] == "8":
            angle = 3
        running = 2
...
def block1_incorrect():
    ...
    while running ==1:
        ...
        if ment_rot_angle[1] == "3" and ment_rot_angle[2] == "2" or ment_rot_angle[1] == "3" and ment_rot_angle[2] == "3":
            angle = 1
        if ment_rot_angle[1] == "3" and ment_rot_angle[2] == "6" or ment_rot_angle[1] == "3" and ment_rot_angle[2] == "7" or ment_rot_angle[1] == "3" and ment_rot_angle[2] == "9" or ment_rot_angle[1] == "4" and ment_rot_angle[2] == "1":
            angle = 2
        elif ment_rot_angle[1] == "1" and ment_rot_angle[2] == "_" or ment_rot_angle[1] == "4" and ment_rot_angle[2] == "4" or ment_rot_angle[1] == "4" and ment_rot_angle[2] == "5" or ment_rot_angle[1] == "4" and ment_rot_angle[2] == "7":
            angle = 3
        running = 2
...
def block2_correct():
    ...
    global block2_corr, lownegative_stimlist, block2_meanRT
    running = 1
    
    while running ==1:
        
        for frames in range(arous_image_frames):
            lownegative_stimlist[0].draw()
            window.flip()
        ...
        image = lownegative_stimlist[0].name
        ment_rot_image = block2_corr[0].name
        ment_rot_angle = block2_corr[0].name.split("Correct")[1]
        
        if ment_rot_angle[1] == "3" and ment_rot_angle[2] == "_" or ment_rot_angle[1] == "6" and ment_rot_angle[2] == "_":
            angle = 1
        if ment_rot_angle[1] == "7" and ment_rot_angle[2] == "_" or ment_rot_angle[1] == "1" and ment_rot_angle[2] == "0" or ment_rot_angle[1] == "1" and ment_rot_angle[2] == "2" or ment_rot_angle[1] == "1" and ment_rot_angle[2] == "4":
            angle = 2
        elif ment_rot_angle[1] == "1" and ment_rot_angle[2] == "5" or ment_rot_angle[1] == "1" and ment_rot_angle[2] == "8" or ment_rot_angle[1] == "2" and ment_rot_angle[2] == "0" or ment_rot_angle[1] == "2" and ment_rot_angle[2] == "2":
            angle = 3
...
def block2_incorrect():
    ...
    global block2_incorr, lownegative_stimlist, block2_meanRT
    running = 1
    ...
    while running ==1:
        ...
        if ment_rot_angle[1] == "4" and ment_rot_angle[2] == "_" or ment_rot_angle[1] == "5" and ment_rot_angle[2] == "_":
            angle = 1
        if ment_rot_angle[1] == "8" and ment_rot_angle[2] == "_" or ment_rot_angle[1] == "9" and ment_rot_angle[2] == "_" or ment_rot_angle[1] == "1" and ment_rot_angle[2] == "1" or ment_rot_angle[1] == "1" and ment_rot_angle[2] == "3":
            angle = 2
        elif ment_rot_angle[1] == "1" and ment_rot_angle[2] == "6" or ment_rot_angle[1] == "1" and ment_rot_angle[2] == "7" or ment_rot_angle[1] == "1" and ment_rot_angle[2] == "9" or ment_rot_angle[1] == "2" and ment_rot_angle[2] == "1":
            angle = 3
...
def block3_correct():
    ...
    block = '3'
    valence = 'high negative'
    stim_tim = '-'
    keyTime = '-'
    thisResp = '-'
    
    global block3_corr, highnegative_stimlist, block3_meanRT
    running = 1
    
    while running ==1:
        
        for frames in range(arous_image_frames):
            highnegative_stimlist[0].draw()
            window.flip()
        ...
        image = highnegative_stimlist[0].name
        ment_rot_image = block3_corr[0].name
        ment_rot_angle = block3_corr[0].name.split("Correct")[1]
        angle = "-"
        
        if ment_rot_angle[1] == "2" and ment_rot_angle[2] == "3" or ment_rot_angle[1] == "2" and ment_rot_angle[2] == "6":
            angle = 1
        if ment_rot_angle[1] == "2" and ment_rot_angle[2] == "8" or ment_rot_angle[1] == "3" and ment_rot_angle[2] == "0" or ment_rot_angle[1] == "3" and ment_rot_angle[2] == "2" or ment_rot_angle[1] == "3" and ment_rot_angle[2] == "4":
            angle = 2
        elif ment_rot_angle[1] == "3" and ment_rot_angle[2] == "5" or ment_rot_angle[1] == "3" and ment_rot_angle[2] == "7" or ment_rot_angle[1] == "3" and ment_rot_angle[2] == "9" or ment_rot_angle[1] == "4" and ment_rot_angle[2] == "1":
            angle = 3
...
def block3_incorrect():
    ...
    global block3_incorr, highnegativestimlist, block3_meanRT
    running = 1
    ...
    while running ==1:
        ...
        if ment_rot_angle[1] == "2" and ment_rot_angle[2] == "4" or ment_rot_angle[1] == "2" and ment_rot_angle[2] == "5":
            angle = 1
        if ment_rot_angle[1] == "2" and ment_rot_angle[2] == "7" or ment_rot_angle[1] == "2" and ment_rot_angle[2] == "9" or ment_rot_angle[1] == "3" and ment_rot_angle[2] == "1" or ment_rot_angle[1] == "3" and ment_rot_angle[2] == "3":
            angle = 2
        elif ment_rot_angle[1] == "3" and ment_rot_angle[2] == "6" or ment_rot_angle[1] == "3" and ment_rot_angle[2] == "8" or ment_rot_angle[1] == "4" and ment_rot_angle[2] == "0" or ment_rot_angle[1] == "4" and ment_rot_angle[2] == "2":
            angle = 3
...
practice_trials = [practice_correct,practice_correct,practice_correct,practice_incorrect,practice_incorrect,practice_incorrect]
...
while running:
    ...
    print "overall mean RT for low neg: %f"   %(block2_meanRT)
    print "overall mean RT for high neg: %f"  %(block3_meanRT)
